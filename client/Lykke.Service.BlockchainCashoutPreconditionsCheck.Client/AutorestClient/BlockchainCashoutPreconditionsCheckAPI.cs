...
namespace Lykke.Service.BlockchainCashoutPreconditionsCheck.Client.AutorestClient
{
    ...
    public partial class BlockchainCashoutPreconditionsCheckAPI : ServiceClient<BlockchainCashoutPreconditionsCheckAPI>, IBlockchainCashoutPreconditionsCheckAPI
    {
        ...
        /// True: will dispose the provided httpClient on calling BlockchainCashoutPreconditionsCheckAPI.Dispose(). False: will not dispose provided httpClient</param>
        public BlockchainCashoutPreconditionsCheckAPI(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
