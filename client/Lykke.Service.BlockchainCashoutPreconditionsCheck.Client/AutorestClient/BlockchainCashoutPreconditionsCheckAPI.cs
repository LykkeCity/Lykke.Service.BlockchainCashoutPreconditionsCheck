...
namespace Lykke.Service.BlockchainCashoutPreconditionsCheck.Client.AutorestClient
{
    ...
    public partial class BlockchainCashoutPreconditionsCheckAPI : ServiceClient<BlockchainCashoutPreconditionsCheckAPI>, IBlockchainCashoutPreconditionsCheckAPI
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the BlockchainCashoutPreconditionsCheckAPI class.
        /// </summary>
        /// <param name='handlers'>
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public BlockchainCashoutPreconditionsCheckAPI(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public BlockchainCashoutPreconditionsCheckAPI(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public BlockchainCashoutPreconditionsCheckAPI(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public BlockchainCashoutPreconditionsCheckAPI(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        public async Task<HttpOperationResponse<object>> IsBlockedWithHttpMessagesAsync(string blockchainType, string blockedAddress, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IsBlockedResponse>(_responseContent, DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<object>> GetWithHttpMessagesAsync(string blockchainType, string blockedAddress, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<BlackListResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> GetAllWithHttpMessagesAsync(string blockchainType, int? take = default(int?), string continuationToken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (blockchainType == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "blockchainType");
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<BlackListEnumerationResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<ErrorResponse>> UpdateWithHttpMessagesAsync(AddBlackListModel request = default(AddBlackListModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (request != null)
            {
                request.Validate();
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/BlackList").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<ErrorResponse>> AddWithHttpMessagesAsync(AddBlackListModel request = default(AddBlackListModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (request != null)
            {
                request.Validate();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<object>> CheckWithHttpMessagesAsync(string assetId, string destinationAddress, double? amount = default(double?), System.Guid? clientId = default(System.Guid?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (assetId == null)
            {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/CashoutCheck").ToString();
            List<string> _queryParameters = new List<string>();
            if (assetId != null)
            {
            ...
            if (clientId != null)
            {
                _queryParameters.Add(string.Format("ClientId={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(clientId, SerializationSettings).Trim('"'))));
            }
            if (_queryParameters.Count > 0)
            {
                _url += "?" + string.Join("&", _queryParameters);
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CashoutValidityResult>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
