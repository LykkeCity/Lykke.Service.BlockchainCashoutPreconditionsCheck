...
namespace Lykke.Service.BlockchainCashoutPreconditionsCheck.Client.AutorestClient
{
    ...
    public static partial class BlockchainCashoutPreconditionsCheckAPIExtensions
    {
            ...
            /// <param name='clientId'>
            /// </param>
            public static object Check(this IBlockchainCashoutPreconditionsCheckAPI operations, string assetId, string destinationAddress, double? amount = default(double?), System.Guid? clientId = default(System.Guid?))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> CheckAsync(this IBlockchainCashoutPreconditionsCheckAPI operations, string assetId, string destinationAddress, double? amount = default(double?), System.Guid? clientId = default(System.Guid?), CancellationToken cancellationToken = default(CancellationToken))
            {
